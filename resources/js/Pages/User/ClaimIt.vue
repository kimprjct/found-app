...
const submit = (found) => {
        ...
        form.post(route("claimit.store", found.id), {
            onSuccess: () => {
                Swal.fire({
                    title: "THANK YOU!",
...
<template>
    ...
    <UserLayout>
        ...
        <section class="report-section">
            <h2>lost Item Verification Form   </h2>
            <form class="report-form"  @submit.prevent="submit(props.found)">
                ...
                <div class="form-group">
                    <label for="item-description"
                        >Description of the lost Item:</label
                    >
                    <textarea
                        id="item-description"
                ...
                <div class="checkbox-group">
                    ...
                    />
                    <label for="certify"
                        >I certify that I lost this item and the information
